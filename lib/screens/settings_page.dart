...
class SettingsPage extends StatelessWidget {
  ...
  static SettingsController get _ctrl {
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Configure the CityFix admin console',
                              style: GoogleFonts.plusJakartaSans(
                      ...
                      children: [
                          ...
                          child: _buildSettingsSection(
                            ...
                            tiles: [
                              _SettingTile(
                                ...
                                sub: 'Get notified when a report is submitted',
                                rxValue: ctrl.newReportAlerts,
                              ),
                              _SettingTile(
                                label: 'High-confirmation alerts',
                                sub:
                                    'Alert when a report exceeds 10 confirmations',
                                rxValue: ctrl.highConfirmAlerts,
                              ),
                              _SettingTile(
                                label: 'Weekly digest',
                                sub: 'Receive a weekly summary email',
                                rxValue: ctrl.weeklyDigest,
                              ),
                            ],
                          ),
                        ),
                        ...
                        Expanded(
                          child: _buildSettingsSection(
                            ...
                            tiles: [
                              _SettingTile(
                                label: 'Arabic language support',
                                sub: 'Enable RTL layout for Arabic users',
                                rxValue: ctrl.arabicLanguage,
                              ),
                              _SettingTile(
                                label: 'French translation',
                                sub: 'Display UI in French',
                                rxValue: ctrl.frenchTranslation,
                              ),
                            ],
                          ),
                        ),
